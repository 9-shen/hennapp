...
import img_1 from "@/public/AppParallax/1.jpg"; 
    ...
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          layout="fill"
          objectFit="cover"
          className="filter blur-md transform -translate-y-10" // Add any additional classes here
        />
      </div>
      {/* Overlay for content */}
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
        <p className="mx-auto -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
          Henna
          <span className="border-b border-dotted border-slate-300"> APP</span>
        </p>
        ...
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          <span className="inline-block">
            ...
            <span className="relative whitespace-nowrap text-blue-600">
              ...
              <span className="relative text-pink-500">Mobile</span>
            </span>
          </span>{" "}
          App
        </h1>
        ...
        <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
          <span className="inline-block">Unlock business opportunities with Hennapp!
        </span>
        </p>
