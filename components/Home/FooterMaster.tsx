        ...
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          ...
          <div className="mt-8 md:mt-0 md:w-[316px]">
            ...
            <div className="mt-8 flex flex-col gap-2">
              ...
              <Link href="#" className="font-Inter text-[14px] font-medium text-white">About</Link>
              <Link href="#" className="font-Inter text-[14px] font-medium text-white">Services</Link>
              <Link href="#" className="font-Inter text-[14px] font-medium text-white">blog</Link>
              <Link href="#" className="font-Inter text-[14px] font-medium text-white">Contact</Link>
            </div>
          </div>
        </div>
      </div>
